      ...
      <Card className="w-full max-w-md border-ocean-200 shadow-xl">
        <CardHeader className="space-y-1 text-center">
          <div className="flex justify-center mb-4">
            <img src="https://mgx-backend-cdn.metadl.com/generate/images/843310/2026-01-04/a0d2406a-5fdc-454f-a92d-f8eaac40d0b5.png" alt="FishLog" className="h-20 w-20 rounded-full object-cover border-4 border-ocean-300 shadow-lg" />
          </div>
